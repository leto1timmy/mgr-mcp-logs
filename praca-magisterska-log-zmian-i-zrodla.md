...
| `CHG-2026-06-22-02` | 2026-06-22 | `praca-magisterska-plan.md` / cel i zakres | Rozbudowano cel, pytania badawcze i zakres pracy bez zmiany zatwierdzonego tematu. | Część analityczna i ewaluacyjna powinna wynikać z celu oraz struktury pracy, natomiast temat pozostaje w pierwotnym brzmieniu: "Projekt i implementacja serwera MCP do analizy logów w systemach mikroserwisowych". | `MCP-SPEC-2025-11-25`, `OPENAI-MCP-CONNECTORS` |
...
| `CHG-2026-06-22-11` | 2026-06-22 | `praca-magisterska-plan.md`, `praca-magisterska-plan-skrocony.md` | Przywrócono oryginalne brzmienie tematu i przebudowano skrócony plan na formalny spis treści pracy magisterskiej z rozdziałami, podrozdziałami, zakończeniem, bibliografią i załącznikami. | Temat został już zaakceptowany w korespondencji z promotorem, więc nie powinien być zmieniany. Skrócony plan powinien wyglądać jak plan właściwej pracy magisterskiej, a nie jak opis projektu. | `MCP-SPEC-2025-11-25`, `OTEL-OBSERVABILITY`, `MCP-TOOLS-2025-11-25` |
...
| 7. Zakończenie | źródła z rozdziałów 2, 4 i 6 |
